 ...
 \end{itemize}
	...
	\section{Programming}
		...
		\subsection{Projects \& Hackathons}
            ...
            \item \textbf{Joint Advanced Student School Cyprus 2024} ``Talking with Smart Cities" - Smart assistant for booking parking spaces in an eGarage, with driverless robots.               % \textit{Presented to mock investors from Leptos}
            % JASS project
            % Website Change Alert
            % Swapify?
